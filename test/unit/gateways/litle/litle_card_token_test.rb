...
require 'active_merchant/billing/gateways/litle/litle_card_token'

class CardTokenTest < Test::Unit::TestCase
  def setup
    @card_token = LitleCardToken.new(:token              => '1234567890123456',
                                     :month              => 9,
